...
ja:{
  ...
  footP:'四柱命式に刻まれた生まれつきの気質 × MBTI表現<br>環境が作った自分ではなく、<strong style="color:var(--g2)">生まれた時からの自分</strong>に出会おう 🌸',
...
'zh-TW':{
  ...
  err:'⚠️ 請輸入6位出生日期和性別',
  btnStart:'喵星的能量分析開始 🔮',
  footP:'四柱命盤中的先天氣質 × MBTI表達<br>遇見<strong style="color:var(--g2)">從出生那天就存在的你</strong> 🌸',
...
'zh-CN':{
  ...
  err:'⚠️ 请输入6位出生日期和性别',
  btnStart:'喵星的能量分析开始 🔮',
  footP:'四柱命盘中的先天气质 × MBTI表达<br>遇见<strong style="color:var(--g2)">从出生那天就存在的你</strong> 🌸',
